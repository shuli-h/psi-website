...
export default function Header() {
  ...
  return (
    <header className="w-full bg-white sticky top-0 z-50">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 flex flex-col gap-4" dir="rtl">
          <Link
            href="/"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-white text-lg font-light px-6 py-2.5 rounded-full flex items-center justify-center gap-2 transition-all duration-300 tracking-wide"
