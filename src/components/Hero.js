    ...
    <section className="w-full min-h-[90vh] flex flex-col md:flex-row relative">
      ...
      <div className="w-full md:w-1/2 flex items-center" style={{ backgroundColor: '#e0f8e3' }}>
        <div className="pl-10 pr-4 py-16 md:pl-16 md:pr-6 md:py-0 max-w-xl w-full ml-auto" dir="rtl" style={{ fontFamily: 'var(--font-rubik)' }}>
          ...
          {/* Eyebrow label */}
          <p className="text-blue-700 font-semibold text-sm uppercase tracking-widest mb-4 text-right" style={{ letterSpacing: '0.3em' }}>
            ברוכים הבאים ל-PSI
          </p>

          {/* Main heading */}
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6 text-right">
            <span className="md:whitespace-nowrap">בדיקות בטיחות מקצועיות</span>
            <br className="hidden md:block" />
            {' '}
            <span className="text-blue-700">למתקני משחקים וכושר</span>
          </h1>

          {/* Supporting paragraphs */}
          <p className="text-gray-600 text-lg leading-relaxed mb-4 text-right">
            אנו מספקים שירותי בדיקות בטיחות, ייעוץ מקצועי ופתרונות משלימים בתחום מתקני המשחק והכושר, במטרה להבטיח סביבת פעילות בטוחה, תקינה ועומדת בדרישות התקנים המחייבים.
          </p>
          <p className="text-gray-600 text-lg leading-relaxed mb-4 text-right">
            השירותים מבוצעים על ידי <strong>מהנדס מכונות</strong>, בעל הכשרה מקצועית והסמכה לביצוע בדיקות שנתיות לאחר הכשרה ייעודית של מכון התקנים הישראלי, תוך הקפדה על מקצועיות, יסודיות וליווי אישי לאורך כל הדרך.
          </p>
          <p className="text-gray-600 text-lg leading-relaxed mb-8 text-right">
            אנו מעניקים שירות לגני ילדים, בתי ספר, רשויות מקומיות, קיבוצים, מושבים, חברות תחזוקה, מוסדות ציבוריים ולקוחות פרטיים.
          </p>
